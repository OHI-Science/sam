...
```{r np, echo=FALSE, warning=FALSE, message=FALSE}
np_harvest_tonnes_csv <- read_csv("/Users/julialowndes/github/ohi-global2017-template/global2017/gapfilling/layers/np_harvest_tonnes.csv")
