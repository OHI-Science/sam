...
# copy layers into specific scenario / layers folder ## JULIE: may not need this for country-opportunities-training (this is just a check really, nothing should change)
...
# layers registry (this includes files that are ingest=FALSE)
    ...
    write.csv(lyrs_reg, 'layers.csv', row.names=FALSE, na='')
...
write.csv(scores_all_years, 'scores.csv', na='', row.names=FALSE)
