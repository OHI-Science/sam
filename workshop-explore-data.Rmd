...
## Species goals
ico_spp_cat_csv <- read_csv(file.path(raw_prefix, "ohiprep_v2017/master/globalprep/spp_ico/v2017/int/ico_spp_cat.csv"))
ico_spp_rgn_prepped_csv <- read_csv(file.path(raw_prefix, "ohiprep_v2017/master/globalprep/spp_ico/v2017/int/ico_spp_rgn_prepped.csv"))
risk_code_lookup <- read_csv(file.path(raw_prefix, "ohiprep_v2017/master/globalprep/spp_ico/v2017/raw/risk_code_lookup.csv"))
...
These are the species included: 

```{r ico_spp, echo=FALSE}
ico_spp_rgn_prepped <- ico_spp_rgn_prepped_csv %>%
  filter(rgn_id == rgn_global$rgn_id)

ico_spp_code <- ico_spp_rgn_prepped %>%
