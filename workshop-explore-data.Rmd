...
## join iucn category language THIS ISN"T RIGHT
spp_code <- rgn_spp_gl %>%
...
# ### old pre-casey, not right, just 11 variables.
# ico_spp_rgn_prepped <- ico_spp_rgn_prepped_csv %>%
#   filter(rgn_id == rgn_global$rgn_id)
# 
# ico_spp_code2 <- ico_spp_rgn_prepped %>%
#   left_join(risk_code_lookup %>%
#               select(cat_code = code,
#                      category,
#                      cat_score) %>%
...
TODO Casey: ico_spp_iucn_status.csv is from functions.r
This is the ICO list: ohiprep/globalprep/spp_ico/v2017/output
