...
Now, let's check Samoa's flower plot. The `plot_flower_local()` function will make figures for you, saving them as .pngs in `sam/toolbox-demo/reports/figures` and displaying them in the RStudio Viewer (they will look a bit cut-off in the Viewer but that is just a vizualization glitch; the .pngs are fine).  
